...
export class MaterialFactory {
    ...
    static getPavement(scene : BABYLON.Scene): BABYLON.StandardMaterial{
        if (!this.pavementMaterial){
            const material = new BABYLON.StandardMaterial("pavement", scene);
            const scale: int = 10;
            const groundPath : string = "public/asset/textures/pavement/pavement.png";
            ...
            material.specularTexture = new BABYLON.Texture("public/asset/textures/pavement/pavement_road_ambiant.png",
            ...
            material.ambientTexture = new BABYLON.Texture("public/asset/textures/pavement/pavement_road_ambiant.png", scene,
                false,false, BABYLON.Texture.NEAREST_SAMPLINGMODE);
            // @ts-ignore
            ...
            material.bumpTexture = new BABYLON.Texture("public/asset/textures/pavement/pavement_road_normal.png",
                scene,false,false,BABYLON.Texture.NEAREST_SAMPLINGMODE);
            // @ts-ignore
