...
export class Hud {
    ...
    //Game Timer
    public time: number | undefined; //keep track to signal end game REAL TIME
    private _prevTime: number = 0;
    private _clockTime: TextBlock = null; //GAME TIME
    private _startTime: number | undefined;
    private _stopTimer: boolean | undefined;
    private _sString = "00";
    private _mString = 11;
    ...
    //Timer handlers
    public stopSpark: boolean | undefined;
    private _handle: number | undefined;
    private _sparkhandle: number | undefined;

    //Pause toggle
    public gamePaused: boolean | undefined;

    //Quit game
    public quit: boolean | undefined;
    public transition: boolean = false;

    //UI Elements
    public pauseBtn: Button;
    public fadeLevel: number | undefined;
    private _playerUI;
    private _pauseMenu;
    private _controls;
    public tutorial;
